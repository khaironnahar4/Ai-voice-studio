...
type Tag = "Male" | "Female" | "Narration" | "Conversational" | "News";
...
export default function Voices() {
  ...
  const filtered = useMemo(() => {
    if (activeFilter === "All") return VOICES;
    return VOICES.filter((v) => v.tags.includes(activeFilter));
  }, [activeFilter]);
  ...
  return (
    ...
    >
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Filter tabs */}
        <div
          className="reveala opacity-100 translate-y-8 transition-all duration-700 ease-out flex flex-wrap justify-center gap-2 mb-10"
          role="tablist"
          aria-label="Filter voices by type"
        >
          {FILTERS.map((f) => (
            <button
              key={f}
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${voice.hue}99, ${voice.hue})`,
                  }}
                  // aria-hidden="true"
                >
                  {voice.initials}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-vocera-muted mb-2">
                    {voice.accent}
                  </div>
        ...
        {/* CTA */}
        <div className="reveala opacity-100 translate-y-8 transition-all duration-700 ease-out text-center mt-16">
          <a
            href="/voices"
